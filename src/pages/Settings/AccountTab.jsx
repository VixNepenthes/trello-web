...
function AccountTab() {
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    toast.promise(dispatch(updateUserAPI({ displayName })), { pending: 'Updating...' }).then((data) => {
      if (!data.error) {
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(dispatch(updateUserAPI(reqData)), { pending: 'Updating...' }).then((response) => {
      if (!response.error) {
        toast.success('Updated successfully!')
      }
      e.target.value = ''
